...
import {
  ...
  BookOpen, FileText, FolderOpen, Gift,
  Library, Settings, ShieldCheck, CreditCard,
} from "lucide-react";
...
const menuItems = [
  ...
  { icon: BookOpen, label: "توليد خطة درس", path: "/generate" },
  { icon: FileText, label: "خططي وأوراق عملي", path: "/my-plans" },
  { icon: FolderOpen, label: "اختياراتي المحفوظة", path: "/selections" },
  { icon: Library, label: "الموارد التربوية", path: "/resources" },
  { icon: Gift, label: "الإحالات", path: "/referrals" },
  { icon: CreditCard, label: "الاشتراك والدفع", path: "/subscription" },
];

const adminMenuItems = [
  { icon: ShieldCheck, label: "لوحة المدير", path: "/admin" },
];
...
export default function DashboardLayout({
  ...
  return (
    ...
    >
      <DashboardLayoutContent setSidebarWidth={setSidebarWidth} menuItems={allItems}>
        {children}
          ...
          <SidebarHeader className="h-16 justify-center">
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                ...
                <BookOpen className="h-5 w-5 text-primary shrink-0 mx-auto" />
              )}
            </div>
          </SidebarHeader>
